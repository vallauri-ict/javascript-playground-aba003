...
window.onload=function(){
	_btncolo=document.getElementById("btnColore");
	_btncolo.setAttribute("onclick","cambiaColore()");
	
	_titolo=document.getElementById("titolo");
	_btnDim=document.getElementById("btnDimensione");
	
	_btnDim.setAttribute("onclick","cambiaDimensione()");
